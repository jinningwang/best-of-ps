...
- [GitHub](https://github.com/cuihantao/andes) (👨‍💻 18 · 🔀 63 · 📦 7 · 📋 44 - 6% open · ⏱️ 22.12.2022):

	```
	git clone https://github.com/cuihantao/andes
	```
- [PyPi](https://pypi.org/project/andes) (📥 500 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 99 · 🔀 380 · 📦 190 · 📋 780 - 18% open · ⏱️ 22.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pandapower) (📥 12K / month):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 55 · 🔀 320 · 📦 80 · 📋 220 - 24% open · ⏱️ 21.12.2022):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 27 · 🔀 72 · 📥 23 · 📦 3 · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 940 / month):
	```
	pip install GridCal
	```
</details>
...
<details><summary><b><a href="https://matpower.org/">matpower</a></b> (🥈20 ·  ⭐ 290) - Steady state power flow simulation. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 12 · 🔀 120 · 📥 150K · 📋 120 - 8% open · ⏱️ 13.12.2022):
...
- [PyPi](https://pypi.org/project/matpower) (📥 120 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 380 · ⏱️ 23.11.2022):
	```
	docker pull matpower/matpower
	```
</details>
<details><summary><b><a href="https://github.com/alliander-opensource/power-grid-model">Power Grid Model</a></b> (🥈20 ·  ⭐ 58 · 📈) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/alliander-opensource/power-grid-model) (👨‍💻 12 · 🔀 10 · 📥 780 · 📋 56 - 46% open · ⏱️ 22.12.2022):

	```
	git clone https://github.com/alliander-opensource/power-grid-model
	```
- [PyPi](https://pypi.org/project/power-grid-model) (📥 6K / month):
	```
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 18 · 🔀 90 · 📦 73 · 📋 35 - 68% open · ⏱️ 24.06.2022):

	```
	git clone https://github.com/rwl/PYPOWER
	```
- [PyPi](https://pypi.org/project/PYPOWER) (📥 2.4K / month):
	```
	pip install PYPOWER
	```
...
<details><summary><b><a href="https://pypsa.org">PyPSA-Eur</a></b> (🥉18 ·  ⭐ 170 · 📉) - Optimisation Model of the European Transmission System. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 34 · 🔀 100 · 📋 170 - 31% open · ⏱️ 20.12.2022):
...
<details><summary><b><a href="https://pypsa.org">PyPSA-Eur-Sec</a></b> (🥉16 ·  ⭐ 67) - Sector-Coupled Optimisation Model of the European Energy System. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 7 · 🔀 25 · 📥 380 · 📋 300 - 21% open · ⏱️ 21.06.2022):
...
- [GitHub](https://github.com/BDonnot/lightsim2grid) (🔀 9 · 📥 38 · 📦 18 · 📋 29 - 41% open · ⏱️ 20.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/LightSim2Grid) (📥 1.2K / month):
	```
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 37 · 🔀 33 · 📥 16K · 📋 600 - 11% open · ⏱️ 02.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 1.8K / month):
	```
	pip install helics
	```
...
<details><summary><b><a href="https://github.com/mzy2240/ESA">Easy SimAuto</a></b> (🥇19 ·  ⭐ 32) - Python interface to PowerWorld. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 10 · 🔀 6 · 📦 3 · 📋 83 - 9% open · ⏱️ 10.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 790 / month):
	```
	pip install esa
	```
</details>
<details><summary><b><a href="https://github.com/PauloRadatz/py_dss_interface">py-dss-interface</a></b> (🥈18 ·  ⭐ 15) - A package for access to direct dll version of OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 19 · 📋 88 - 17% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/OpenDSSDirect.py) (📥 2K / month):
	```
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 23 · 🔀 15 · 📦 2 · 📋 23 - 60% open · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pydss) (📥 17 / month):
	```
	pip install pydss
	```
</details>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 45 · 🔀 88 · 📦 5 · 📋 350 - 16% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/scikit-highs) (📥 140 / month):
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 120 · 🔀 400 · 📥 540 · 📦 1.1K · 📋 1.1K - 26% open · ⏱️ 20.12.2022):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 130 · 🔀 360 · 📋 1.3K - 1% open · ⏱️ 21.12.2022):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 21 · 🔀 82 · 📋 230 - 13% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 510 / month):
	```
	pip install Grid2Op
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 230 · 📥 340 · 📋 6.7K - 22% open · ⏱️ 22.12.2022):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 46 · 🔀 130 · 📥 13K · 📋 630 - 24% open · ⏱️ 22.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 180 / month):
	```
...
<details><summary><b><a href="https://www.pandapipes.org/">pandapipes</a></b> (🥇21 ·  ⭐ 70) - Pipeflow Calculation Tool. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 22 · 🔀 49 · 📦 16 · 📋 96 - 26% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/PyPSA/atlite
	```
- [PyPi](https://pypi.org/project/atlite) (📥 830 / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 15 · 🔀 35 · 📥 36 · 📦 13 · 📋 55 - 20% open · ⏱️ 21.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 160 / month):
	```
...
<details><summary><b><a href="https://github.com/devbisme/skidl">skidl</a></b> (🥇19 ·  ⭐ 810 · 💤) - Module to Design Electronic Circuits. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/devbisme/skidl) (👨‍💻 21 · 🔀 96 · 📦 19 · 📋 98 - 30% open · ⏱️ 05.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/skidl) (📥 180 / month):
	```
	pip install skidl
	```

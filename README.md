...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 98 · 🔀 380 · 📦 190 · 📋 780 - 19% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 55 · 🔀 320 · 📦 79 · 📋 220 - 24% open · ⏱️ 14.12.2022):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 2.7K / month):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 27 · 🔀 72 · 📥 23 · 📦 2 · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 460 / month):
	```
	pip install GridCal
	```
</details>
...
- [PyPi](https://pypi.org/project/matpower) (📥 69 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 370 · ⏱️ 23.11.2022):
	```
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 34 · 🔀 100 · 📋 170 - 30% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/alliander-opensource/power-grid-model) (👨‍💻 12 · 🔀 10 · 📥 740 · 📋 53 - 47% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/alliander-opensource/power-grid-model
	```
- [PyPi](https://pypi.org/project/power-grid-model) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 37 · 🔀 33 · 📥 16K · 📋 600 - 11% open · ⏱️ 02.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 1.1K / month):
	```
	pip install helics
	```
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 10 · 🔀 6 · 📦 3 · 📋 83 - 9% open · ⏱️ 10.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 490 / month):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 5 · 🔀 6 · 📦 13 · 📋 53 - 60% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 150 / month):
	```
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 45 · 🔀 86 · 📦 5 · 📋 350 - 15% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/scikit-highs) (📥 63 / month):
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 120 · 🔀 400 · 📥 490 · 📦 1.1K · 📋 1.1K - 26% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 130 · 🔀 360 · 📋 1.3K - 1% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 21 · 🔀 82 · 📋 230 - 13% open · ⏱️ 12.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 430 / month):
	```
	pip install Grid2Op
	```
...
<details><summary><b><a href="https://openmodelica.org">OpenModelica</a></b> (🥇28 ·  ⭐ 550) - Modelica-based environment for modeling and simulation. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>

- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 230 · 📥 340 · 📋 6.7K - 22% open · ⏱️ 15.12.2022):
...
<details><summary><b><a href="https://precice.org/">precice</a></b> (🥉23 ·  ⭐ 480) - Precise Code Interaction Coupling Environment. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/precice/precice) (👨‍💻 46 · 🔀 130 · 📥 13K · 📋 630 - 24% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 15 · 🔀 33 · 📦 6 · 📋 91 - 53% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pandapipes) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 22 · 🔀 48 · 📦 15 · 📋 96 - 26% open · ⏱️ 09.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/atlite) (📥 900 / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 15 · 🔀 35 · 📥 36 · 📦 12 · 📋 54 - 22% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 72 / month):
	```
...
- [GitHub](https://github.com/devbisme/skidl) (👨‍💻 21 · 🔀 96 · 📦 19 · 📋 98 - 30% open · ⏱️ 05.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/skidl) (📥 100 / month):
	```
	pip install skidl
	```

...
- [GitHub](https://github.com/cuihantao/andes) (👨‍💻 18 · 🔀 65 · 📦 7 · 📋 44 - 6% open · ⏱️ 22.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/andes) (📥 540 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/OpenIPSL/OpenIPSL) (👨‍💻 27 · 🔀 41 · 📥 480 · 📋 110 - 14% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 99 · 🔀 380 · 📦 190 · 📋 780 - 18% open · ⏱️ 02.01.2023):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 55 · 🔀 320 · 📦 81 · 📋 220 - 24% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 2.2K / month):
	```
	pip install pypsa
	```
...
<details><summary><b><a href="https://github.com/alliander-opensource/power-grid-model">Power Grid Model</a></b> (🥈22 ·  ⭐ 58 · 📈) - Steady-state distribution power system analysis. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/alliander-opensource/power-grid-model) (👨‍💻 12 · 🔀 10 · 📥 830 · 📋 57 - 45% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/alliander-opensource/power-grid-model
	```
- [PyPi](https://pypi.org/project/power-grid-model) (📥 15K / month):
	```
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 12 · 🔀 130 · 📥 150K · 📋 120 - 8% open · ⏱️ 22.12.2022):
...
- [PyPi](https://pypi.org/project/matpower) (📥 120 / month):
	...
	```
- [Docker Hub](https://hub.docker.com/r/matpower/matpower) (📥 420 · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/NREL-SIIP/PowerSimulations.jl) (👨‍💻 29 · 🔀 43 · 📋 240 - 9% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 27 · 🔀 73 · 📥 23 · 📦 3 · ⏱️ 12.12.2022):

	```
	git clone https://github.com/SanPen/GridCal
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 900 / month):
	```
	pip install GridCal
	```
</details>
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 18 · 🔀 91 · 📦 73 · 📋 36 - 69% open · ⏱️ 24.06.2022):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 34 · 🔀 110 · 📋 170 - 30% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/PyPSA/pypsa-eur-sec) (👨‍💻 20 · 🔀 41 · 📋 120 - 50% open · ⏱️ 05.01.2023):
...
<details><summary><b><a href="https://l2rpn.chalearn.org/">LightSim2Grid</a></b> (🥉14 ·  ⭐ 31 · 💤) - A fast backend for the Grid2Op. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 37 · 🔀 33 · 📥 17K · 📋 600 - 11% open · ⏱️ 02.12.2022):
...
<details><summary><b><a href="https://github.com/mzy2240/ESA">Easy SimAuto</a></b> (🥇18 ·  ⭐ 33) - Python interface to PowerWorld. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 10 · 🔀 7 · 📦 3 · 📋 83 - 9% open · ⏱️ 10.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 750 / month):
	```
	pip install esa
	```
</details>
<details><summary><b><a href="https://github.com/PauloRadatz/py_dss_interface">py-dss-interface</a></b> (🥈16 ·  ⭐ 15 · 📉) - A package for access to direct dll version of OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 5 · 🔀 6 · 📦 15 · 📋 53 - 60% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/py-dss-interface) (📥 120 / month):
	```
...
- [GitHub](https://github.com/dss-extensions/OpenDSSDirect.py) (👨‍💻 3 · 🔀 19 · 📋 88 - 17% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/OpenDSSDirect.py) (📥 1.7K / month):
	```
...
- [GitHub](https://github.com/NREL/PyDSS) (👨‍💻 23 · 🔀 15 · 📦 2 · 📋 23 - 60% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/NREL/PyDSS
	```
- [PyPi](https://pypi.org/project/pydss) (📥 11 / month):
	```
	pip install pydss
	```
</details>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 45 · 🔀 91 · 📦 5 · 📋 360 - 15% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 22 · 🔀 210 · 📥 6.1K · 📋 510 - 0% open · ⏱️ 22.11.2022):
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 120 · 🔀 400 · 📥 580 · 📦 1.1K · 📋 1.1K - 26% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 130 · 🔀 360 · 📋 1.3K - 1% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 21 · 🔀 82 · 📋 240 - 14% open · ⏱️ 12.12.2022):

	```
	git clone https://github.com/rte-france/Grid2Op
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 410 / month):
	```
	pip install Grid2Op
	```
...
<details><summary><b><a href="https://openmodelica.org">OpenModelica</a></b> (🥇27 ·  ⭐ 560 · 📉) - Modelica-based environment for modeling and simulation. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>

- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 180 · 🔀 230 · 📥 340 · 📋 6.7K - 22% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 47 · 🔀 130 · 📥 13K · 📋 630 - 24% open · ⏱️ 04.01.2023):
...
- [Conda](https://anaconda.org/anaconda/pyprecice):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 8.3K · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 16 · 🔀 34 · 📦 6 · 📋 92 - 47% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 22 · 🔀 50 · 📦 16 · 📋 97 - 26% open · ⏱️ 09.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/atlite) (📥 590 / month):
	```
	pip install atlite
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 15 · 🔀 36 · 📥 36 · 📦 13 · 📋 56 - 21% open · ⏱️ 21.12.2022):

...
- [GitHub](https://github.com/dynawo/dynawo) (👨‍💻 60 · 🔀 25 · 📥 18K · 📋 1.6K - 9% open · ⏱️ 24.07.2025):
...
- [GitHub](https://github.com/gridlab-d/gridlab-d) (👨‍💻 76 · 🔀 120 · 📥 6.9K · 📋 1.3K - 24% open · ⏱️ 28.05.2025):
...
- [GitHub](https://github.com/Xyce/Xyce) (👨‍💻 8 · 🔀 31 · 📥 1K · 📋 100 - 30% open · ⏱️ 21.07.2025):
...
- [GitHub](https://github.com/epri-dev/OpenDER) (👨‍💻 2 · 🔀 25 · 📦 3 · ⏱️ 15.04.2025):

	```
	git clone https://github.com/epri-dev/OpenDER
	```
- [PyPi](https://pypi.org/project/opender) (📥 850 / month · ⏱️ 13.04.2025):
	```
	pip install opender
	```
</details>
...
- [GitHub](https://github.com/changgang/steps) (👨‍💻 4 · 🔀 19 · 📥 50 · 📦 7 · 📋 3 - 33% open · ⏱️ 24.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/stepspy) (📥 94 / month · ⏱️ 22.09.2024):
	```
	pip install stepspy
	```
</details>
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 160 · 🔀 510 · 📦 500 · 📋 1.1K - 18% open · ⏱️ 24.07.2025):

	```
	git clone https://github.com/e2nIEE/pandapower
	```
- [PyPi](https://pypi.org/project/pandapower) (📥 64K / month · 📦 68 · ⏱️ 16.06.2025):
	```
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 100 · 🔀 530 · 📦 300 · 📋 430 - 24% open · ⏱️ 24.07.2025):

	```
	git clone https://github.com/PyPSA/PyPSA
	```
- [PyPi](https://pypi.org/project/pypsa) (📥 9.9K / month · 📦 29 · ⏱️ 03.07.2025):
	```
	pip install pypsa
	```
...
- [GitHub](https://github.com/PowerGridModel/power-grid-model) (👨‍💻 26 · 🔀 39 · 📥 750 · 📦 32 · 📋 250 - 36% open · ⏱️ 22.07.2025):

	```
	git clone https://github.com/PowerGridModel/power-grid-model
	```
- [PyPi](https://pypi.org/project/power-grid-model) (📥 51K / month · 📦 8 · ⏱️ 22.07.2025):
	```
	pip install power-grid-model
	```
- [Conda](https://anaconda.org/conda-forge/power-grid-model) (📥 3.6M · ⏱️ 22.07.2025):
	```
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 53 · 🔀 110 · 📥 49 · 📦 10 · 📋 270 - 13% open · ⏱️ 17.07.2025):

	```
	git clone https://github.com/SanPen/GridCal
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 1.3K / month · ⏱️ 11.06.2025):
	```
	pip install GridCal
	```
</details>
...
- [GitHub](https://github.com/powsybl/powsybl-core) (👨‍💻 120 · 🔀 47 · 📦 90 · 📋 680 - 43% open · ⏱️ 24.07.2025):
...
- [GitHub](https://github.com/rwl/PYPOWER) (👨‍💻 22 · 🔀 120 · 📦 150 · 📋 48 - 72% open · ⏱️ 10.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/PYPOWER) (📥 19K / month · 📦 19 · ⏱️ 10.07.2025):
	```
	pip install PYPOWER
	```
...
- [GitHub](https://github.com/powsybl/pypowsybl) (👨‍💻 34 · 🔀 13 · 📥 330 · 📋 260 - 33% open · ⏱️ 23.07.2025):

	```
	git clone https://github.com/powsybl/pypowsybl
	```
- [PyPi](https://pypi.org/project/pypowsybl) (📥 5.4K / month · 📦 8 · ⏱️ 24.07.2025):
	```
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 96 · 🔀 290 · 📋 550 - 27% open · ⏱️ 24.07.2025):
...
- [GitHub](https://github.com/blue-marble/gridpath) (👨‍💻 13 · 🔀 44 · 📥 1.3K · 📦 4 · 📋 340 - 23% open · ⏱️ 17.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/GridPath) (📥 410 / month · ⏱️ 03.07.2025):
	```
...
- [GitHub](https://github.com/NREL-Sienna/PowerSimulations.jl) (👨‍💻 41 · 🔀 72 · 📋 420 - 19% open · ⏱️ 16.06.2025):

	```
	git clone https://github.com/NREL-Sienna/PowerSimulations.jl
	```
</details>
<details><summary><b><a href="https://pypsa-meets-earth.github.io/">PyPSA-Earth</a></b> (🥈20 ·  ⭐ 280) - Open optimisation model for study energy system.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/volunteer.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/pypsa-meets-earth/pypsa-earth) (👨‍💻 80 · 🔀 250 · 📋 540 - 37% open · ⏱️ 20.07.2025):
...
- [GitHub](https://github.com/Gurobi/gurobi-optimods) (👨‍💻 15 · 🔀 34 · 📦 8 · 📋 84 - 29% open · ⏱️ 12.03.2025):
	...
	```
- [PyPi](https://pypi.org/project/gurobi-optimods) (📥 270 / month · ⏱️ 12.03.2025):
	```
...
- [GitHub](https://github.com/IIT-EnergySystemModels/openTEPES) (👨‍💻 8 · 🔀 22 · 📥 120 · 📋 13 - 23% open · ⏱️ 23.07.2025):
...
<details><summary><b><a href="https://pypsa.org">PyPSA-USA</a></b> (🥉17 ·  ⭐ 90) - Power System Model for the United States. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/university.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/PyPSA/pypsa-usa) (👨‍💻 12 · 🔀 32 · 📋 340 - 29% open · ⏱️ 01.07.2025):
...
- [GitHub](https://github.com/pnnl/tesp) (👨‍💻 26 · 🔀 39 · 📥 500 · 📦 2 · 📋 130 - 25% open · ⏱️ 15.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/tesp_support) (📥 140 / month · ⏱️ 15.12.2024):
	```
...
- [GitHub](https://github.com/NREL/ReEDS-2.0) (👨‍💻 14 · 🔀 69 · 📋 25 - 16% open · ⏱️ 10.06.2025):
...
- [GitHub](https://github.com/powsybl/powsybl-open-rao) (👨‍💻 36 · 🔀 8 · 📥 52 · 📋 170 - 33% open · ⏱️ 15.07.2025):
...
- [GitHub](https://github.com/NREL-Sienna/PowerFlows.jl) (👨‍💻 11 · 🔀 21 · 📋 110 - 44% open · ⏱️ 05.05.2025):
...
- [GitHub](https://github.com/pnnl/ExaGO) (👨‍💻 31 · 🔀 13 · 📋 96 - 60% open · ⏱️ 06.06.2025):
...
- [GitHub](https://github.com/NREL-Sienna/PowerNetworkMatrices.jl) (👨‍💻 8 · 🔀 20 · 📋 76 - 42% open · ⏱️ 11.04.2025):
...
- [GitHub](https://github.com/felipemarkson/dssdata) (👨‍💻 2 · 🔀 3 · 📥 56 · 📦 2 · 📋 36 - 13% open · ⏱️ 10.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/dssdata) (📥 33 / month · ⏱️ 24.01.2023):
	```
	pip install dssdata
	```
</details>
...
- [GitHub](https://github.com/NREL-Sienna/PowerSystemsInvestmentsPortfolios.jl) (👨‍💻 5 · 🔀 8 · 📋 34 - 23% open · ⏱️ 21.07.2025):
...
- [GitHub](https://github.com/NREL-Sienna/PowerSystemsInvestments.jl) (👨‍💻 4 · 🔀 11 · 📋 11 - 81% open · ⏱️ 21.07.2025):

	```
	git clone https://github.com/NREL-Sienna/PowerSystemsInvestments.jl
	```
</details>
<details><summary><b><a href="https://github.com/NREL/ASSET">ASSET</a></b> (🥉5 ·  ⭐ 14 · 🐣) - Assess and analyze grid strength. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/lab.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PauloRadatz/py_dss_interface) (👨‍💻 6 · 🔀 10 · 📥 5 · 📦 36 · ⏱️ 23.05.2025):
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 12 · 🔀 12 · 📦 7 · 📋 100 - 15% open · ⏱️ 16.01.2025):
	...
	```
- [PyPi](https://pypi.org/project/esa) (📥 980 / month · 📦 1 · ⏱️ 21.05.2022):
	```
	pip install esa
	```
</details>
...
- [GitHub](https://github.com/dss-extensions/AltDSS-Python) (🔀 1 · 📦 12 · 📋 9 - 77% open · ⏱️ 29.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/altdss) (📥 2.6K / month · 📦 2 · ⏱️ 29.03.2024):
	```
	pip install altdss
	```
</details>
...
- [GitHub](https://github.com/yasirroni/matpower-pip) (👨‍💻 1 · 📦 9 · 📋 18 - 22% open · ⏱️ 21.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/matpower) (📥 170 / month · 📦 2 · ⏱️ 05.10.2024):
	```
...
- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 200 · 🔀 320 · 📥 390 · 📋 8.3K - 24% open · ⏱️ 23.07.2025):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 59 · 🔀 190 · 📥 36K · 📋 930 - 21% open · ⏱️ 24.07.2025):
...
- [Conda](https://anaconda.org/conda-forge/pyprecice) (📥 120K · ⏱️ 18.06.2025):
	...
	```
- [Docker Hub](https://hub.docker.com/r/precice/precice) (📥 28K · ⏱️ 23.07.2025):
	```
...
- [GitHub](https://github.com/Pyomo/pyomo) (👨‍💻 180 · 🔀 530 · 📥 4.8K · 📦 4.5K · 📋 1.4K - 21% open · ⏱️ 24.07.2025):

	```
	git clone https://github.com/Pyomo/pyomo
	```
- [PyPi](https://pypi.org/project/Pyomo) (📥 620K / month · 📦 280 · ⏱️ 21.02.2025):
	```
	pip install Pyomo
	```
...
- [GitHub](https://github.com/cvxpy/cvxpy) (👨‍💻 220 · 🔀 1.1K · 📥 620 · 📦 18K · 📋 1.6K - 16% open · ⏱️ 22.07.2025):

	```
	git clone https://github.com/cvxpy/cvxpy
	```
- [PyPi](https://pypi.org/project/cvxpy) (📥 2.1M / month · 📦 710 · ⏱️ 18.07.2025):
	```
	pip install cvxpy
	```
...
- [GitHub](https://github.com/cvxopt/cvxopt) (👨‍💻 10 · 🔀 210 · 📦 14K · 📋 200 - 23% open · ⏱️ 16.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/cvxopt) (📥 610K / month · 📦 420 · ⏱️ 09.08.2023):
	```
	pip install cvxopt
	```
...
- [GitHub](https://github.com/jump-dev/JuMP.jl) (👨‍💻 160 · 🔀 400 · 📋 1.5K - 0% open · ⏱️ 20.07.2025):
...
- [GitHub](https://github.com/metab0t/PyOptInterface) (👨‍💻 2 · 🔀 16 · 📦 20 · 📋 30 - 26% open · ⏱️ 30.06.2025):
...
- [GitHub](https://github.com/sanurielf/kvxopt) (👨‍💻 16 · 🔀 1 · 📦 31 · ⏱️ 20.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/kvxopt) (📥 7.3K / month · 📦 14 · ⏱️ 20.06.2025):
	```
	pip install kvxopt
	```
...
- [GitHub](https://github.com/google/or-tools) (👨‍💻 190 · 🔀 2.2K · 📥 940K · 📦 350 · 📋 3.1K - 2% open · ⏱️ 17.06.2025):
	...
	```
- [PyPi](https://pypi.org/project/ortools) (📥 2.2M / month · 📦 310 · ⏱️ 19.06.2025):
	```
	pip install ortools
	```
...
- [GitHub](https://github.com/google/or-tools) (👨‍💻 190 · 🔀 2.2K · 📥 940K · 📦 350 · 📋 3.1K - 2% open · ⏱️ 17.06.2025):
	...
	git clone https://github.com/google/or-tools
	```
- [PyPi](https://pypi.org/project/xopt) (📥 680 / month · 📦 3 · ⏱️ 03.07.2025):
	```
	pip install xopt
	```
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 91 · 🔀 230 · 📥 7.2K · 📦 1.8K · 📋 920 - 12% open · ⏱️ 17.07.2025):
...
- [GitHub](https://github.com/scipopt/PySCIPOpt) (👨‍💻 83 · 🔀 270 · 📦 380 · 📋 580 - 4% open · ⏱️ 21.07.2025):
...
- [GitHub](https://github.com/oxfordcontrol/Clarabel.rs) (👨‍💻 11 · 🔀 35 · 📦 42 · 📋 59 - 20% open · ⏱️ 11.06.2025):
...
- [GitHub](https://github.com/coin-or/Ipopt) (👨‍💻 36 · 🔀 290 · 📥 22K · 📋 620 - 1% open · ⏱️ 23.07.2025):

	```
	git clone https://github.com/coin-or/Ipopt
	```
- [PyPi](https://pypi.org/project/ipopt) (📥 930 / month · 📦 10 · ⏱️ 07.04.2021):
	```
	pip install ipopt
	```
...
- [GitHub](https://github.com/coin-or/Cbc) (👨‍💻 34 · 🔀 120 · 📥 97K · 📋 530 - 28% open · ⏱️ 14.07.2025):
...
- [GitHub](https://github.com/ampl/amplpy) (👨‍💻 9 · 🔀 20 · 📦 130 · ⏱️ 09.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/amplpy) (📥 43K / month · 📦 8 · ⏱️ 09.07.2025):
	```
	pip install amplpy
	```
...
- [GitHub](https://github.com/Grid2op/grid2op) (👨‍💻 32 · 🔀 130 · 📋 380 - 15% open · ⏱️ 24.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 1.9K / month · 📦 23 · ⏱️ 24.07.2025):
	```
	pip install Grid2Op
	```
...
<details><summary><b><a href="https://www.powsybl.org">PowSyBl Diagram</a></b> (🥇18 ·  ⭐ 89) - single-line substation diagrams and network graph.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/java.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/for-profit.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/powsybl/powsybl-diagram) (👨‍💻 29 · 🔀 15 · 📦 31 · 📋 180 - 36% open · ⏱️ 22.07.2025):
...
- [GitHub](https://github.com/GMLC-TDC/HELICS) (👨‍💻 39 · 🔀 45 · 📥 28K · 📋 680 - 13% open · ⏱️ 17.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/helics) (📥 6.4K / month · 📦 13 · ⏱️ 28.02.2025):
	```
	pip install helics
	```
...
🔗&nbsp;<b><a href="https://power-grid-lib.github.io">Power Grid Lib - Unit Commitment</a></b> ( ⭐ 97 · 💤)  - Benchmarks for UC. <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/non-profit2.ico" style="display:inline;" width="13" height="13"></code>
...
- [GitHub](https://github.com/gridstatus/gridstatus) (👨‍💻 32 · 🔀 66 · 📦 24 · 📋 120 - 33% open · ⏱️ 21.07.2025):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 42 · 🔀 110 · 📦 110 · 📋 150 - 28% open · ⏱️ 24.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/atlite) (📥 2.5K / month · ⏱️ 12.05.2025):
	```
	pip install atlite
	```
- [Conda](https://anaconda.org/conda-forge/atlite) (📥 91K · ⏱️ 12.05.2025):
	```
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 34 · 🔀 67 · 📥 87 · 📦 83 · 📋 100 - 26% open · ⏱️ 02.07.2025):

	```
	git clone https://github.com/PyPSA/powerplantmatching
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 960 / month · ⏱️ 01.02.2025):
	```
	pip install powerplantmatching
	```
- [Conda](https://anaconda.org/conda-forge/powerplantmatching) (📥 82K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/PowerGenome/PowerGenome) (👨‍💻 18 · 🔀 72 · 📋 180 - 50% open · ⏱️ 21.03.2025):

	```
	git clone https://github.com/PowerGenome/PowerGenome
	```
- [PyPi](https://pypi.org/project/PowerGenome) (📥 20 / month · ⏱️ 21.03.2025):
	```
...
<details><summary><b><a href="https://www.energydatamodel.org/">EnergyDataModel</a></b> (🥉12 ·  ⭐ 65) - Represent energy systems as Python data classes. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/pypi2.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/for-profit.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/rebase-energy/EnergyDataModel) (👨‍💻 3 · 🔀 4 · ⏱️ 07.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/energydatamodel) (📥 29 / month · 📦 2 · ⏱️ 23.03.2025):
	```
...
- [GitHub](https://github.com/gseim/gseim) (👨‍💻 1):
	...
	```
- [PyPi](https://pypi.org/project/GSEIM) (📥 4 / month · ⏱️ 16.07.2022):
	```
	pip install GSEIM
	```
</details>
...
- [GitHub](https://github.com/dsgrid/dsgrid) (👨‍💻 6 · 🔀 29 · 📋 120 - 45% open · ⏱️ 16.07.2025):
	...
	```
- [PyPi](https://pypi.org/project/dsgrid) (📥 21 / month · ⏱️ 18.12.2014):
	```
	pip install dsgrid
	```
</details>
<details><summary><b><a href="https://github.com/NREL/dgen">dGen</a></b> (🥉16 ·  ⭐ 68) - The Distributed Generation Market Demand (dGen) model. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/github.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/python.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/jupyter.ico" style="display:inline;" width="13" height="13"></code> <code><img src="https://github.com/ps-wiki/best-of-ps/blob/main/config/icons/lab.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/cdgaete/pypsa-mcp) (👨‍💻 2 · 🔀 2 · 📥 2 · ⏱️ 22.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/pypsamcp) (📥 46 / month · ⏱️ 22.04.2025):
	```

...
- [GitHub](https://github.com/cuihantao/andes) (👨‍💻 16 · 🔀 61 · 📦 6 · 📋 44 - 9% open · ⏱️ 01.12.2022):

	```
	git clone https://github.com/cuihantao/andes
	```
- [PyPi](https://pypi.org/project/andes) (📥 270 / month):
	```
	pip install andes
	```
...
- [GitHub](https://github.com/e2nIEE/pandapower) (👨‍💻 97 · 🔀 380 · 📦 180 · 📋 770 - 18% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/PyPSA/PyPSA) (👨‍💻 53 · 🔀 310 · 📦 76 · 📋 220 - 24% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/SanPen/GridCal) (👨‍💻 27 · 🔀 71 · 📥 23 · 📦 2 · ⏱️ 13.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/GridCal) (📥 600 / month):
	```
	pip install GridCal
	```
</details>
...
- [GitHub](https://github.com/MATPOWER/matpower) (👨‍💻 12 · 🔀 120 · 📥 140K · 📋 120 - 8% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/matpower) (📥 98 / month):
	```
...
<details><summary><b><a href="https://www.nrel.gov/analysis/siip.html">PowerSimulations.jl</a></b> (🥈20 ·  ⭐ 190) - Optimization Simulation and Modeling of Power.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> <code><img src="https://github.com/JuliaLang/julia-logo-graphics/blob/master/images/julia.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PyPSA/pypsa-eur) (👨‍💻 34 · 🔀 100 · 📋 170 - 29% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/alliander-opensource/power-grid-model) (👨‍💻 12 · 🔀 10 · 📥 680 · 📋 52 - 46% open · ⏱️ 18.11.2022):

	```
	git clone https://github.com/alliander-opensource/power-grid-model
	```
- [PyPi](https://pypi.org/project/power-grid-model) (📥 4.7K / month):
	```
...
<details><summary><b><a href="https://pypsa.org">PyPSA-Eur-Sec</a></b> (🥉16 ·  ⭐ 66 · ➕) - Sector-Coupled Open Optimisation Model of the European.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/mzy2240/ESA) (👨‍💻 9 · 🔀 6 · 📦 3 · 📋 84 - 11% open · ⏱️ 26.10.2022):

	```
	git clone https://github.com/mzy2240/ESA
	```
- [PyPi](https://pypi.org/project/esa) (📥 440 / month):
	```
	pip install esa
	```
</details>
<details><summary><b><a href="https://github.com/PauloRadatz/py_dss_interface">py-dss-interface</a></b> (🥉18 ·  ⭐ 15 · ➕) - Python interface to OpenDSS. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/ERGO-Code/HiGHS) (👨‍💻 45 · 🔀 86 · 📦 5 · 📋 340 - 14% open · ⏱️ 06.12.2022):

	```
	git clone https://github.com/ERGO-Code/HiGHS
	```
- [PyPi](https://pypi.org/project/scikit-highs) (📥 65 / month):
	```
...
- [GitHub](https://github.com/rte-france/Grid2Op) (👨‍💻 21 · 🔀 82 · 📋 230 - 19% open · ⏱️ 05.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Grid2Op) (📥 380 / month):
	```
	pip install Grid2Op
	```
...
<details><summary><b><a href="https://openmodelica.org">OpenModelica</a></b> (🥇28 ·  ⭐ 560) - Modelica-based modeling and simulation environment. <code><a href="https://modelica.org/licenses/ModelicaLicense2/">❗️Custom</a></code></summary>

- [GitHub](https://github.com/OpenModelica/OpenModelica) (👨‍💻 170 · 🔀 230 · 📥 340 · 📋 6.6K - 22% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/precice/precice) (👨‍💻 46 · 🔀 130 · 📥 13K · 📋 620 - 23% open · ⏱️ 06.12.2022):

	```
	git clone https://github.com/precice/precice
	```
- [PyPi](https://pypi.org/project/pyprecice) (📥 190 / month):
	```
...
- [GitHub](https://github.com/e2nIEE/pandapipes) (👨‍💻 13 · 🔀 32 · 📦 6 · 📋 90 - 53% open · ⏱️ 01.12.2022):
...
- [GitHub](https://github.com/PyPSA/atlite) (👨‍💻 22 · 🔀 48 · 📦 15 · 📋 95 - 26% open · ⏱️ 29.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/atlite) (📥 1.4K / month):
	```
	pip install atlite
	```
...
<details><summary><b><a href="https://pypsa.org">powerplantmatching</a></b> (🥉19 ·  ⭐ 93 · ➕) - Set of tools to combine multiple power plant databases. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/PyPSA/powerplantmatching) (👨‍💻 15 · 🔀 35 · 📥 36 · 📦 12 · 📋 54 - 22% open · ⏱️ 01.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/powerplantmatching) (📥 75 / month):
	```
